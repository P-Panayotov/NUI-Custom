...
+ (void)render:(UIBarButtonItem*)item withClass:(NSString*)className
{
    ...
    if ([NUISettings hasProperty:@"background-image" withClass:className]) {
        ...
        if ([NUISettings hasProperty:@"background-color-top" withClass:className]) {
            ...
            CAGradientLayer *gradientLayer = [NUIGraphics gradientLayerWithStart:[NUISettings getColor:@"background-color-top" withClass:className] endC:[NUISettings getColor:@"background-color-bottom" withClass:className] frame:layer.frame startP:startPoint endP:endPoint];

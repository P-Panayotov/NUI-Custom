...
{   
    ...
    if ([NUISettings hasProperty:@"background-color-top" withClass:className]) {
        ...
        UIImage *gradientImage = [NUIGraphics gradientImageWithTop:[NUISettings getColor:@"background-color-top" withClass:className] bottom:[NUISettings getColor:@"background-color-bottom" withClass:className] frame:bar.bounds startP:startPoint endP:endPoint];

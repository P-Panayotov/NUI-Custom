...
+ (void)render:(UIButton*)button withClass:(NSString*)className
{
    ...
    if ([NUISettings hasProperty:@"background-color-top" withClass:className]) {
        ...
        CAGradientLayer *gradientLayer = [NUIGraphics gradientLayerWithStart:[NUISettings getColor:@"background-color-top" withClass:className] endC:[NUISettings getColor:@"background-color-bottom" withClass:className] frame:button.bounds startP:startPoint endP:endPoint];

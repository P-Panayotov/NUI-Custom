...
+ (CAGradientLayer*)gradientLayerWithStart:(id)startColor endC:(id)endColor frame:(CGRect)frame startP:(CGPoint)startPoint endP:(CGPoint)endPoint
{
    ...
    layer.startPoint = startPoint;//CGPointMake(0.5f, 0.0f);
    layer.endPoint = endPoint;//CGPointMake(0.5f, 1.0f);
    return layer;
}

+ (UIImage*)gradientImageWithTop:(id)topColor bottom:(id)bottomColor frame:(CGRect)frame startP:(CGPoint)startPoint endP:(CGPoint)endPoint
{
    CAGradientLayer *layer = [self gradientLayerWithStart:topColor endC:bottomColor frame:frame startP:startPoint endP:endPoint];
